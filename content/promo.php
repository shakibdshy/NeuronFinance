...
<section class="section-padding darker-bg">
    <div class="container">
        ...
        <?php
        global $post;
        $args = array( 'posts_per_page' => 3, 'post_type'=> 'posttype', 'orderby' => 'menu_order', 'order' => 'ASC' );
        $myposts = get_posts( $args );
        foreach( $myposts as $post ) : setup_postdata($post); ?>
        <!-- single intro -->
        <div class="col-md-4">
            <div class="single-intro">
                <div style="background-image:url(<?php the_post_thumnail('large'); ?>)" class="intro-img"></div>
